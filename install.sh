...
c=n d=n h=n i=n I=n l=n r=n s=n u=n w=n v=n BRANCH=main SERVICE=web
...
function setup_chatwoot() {
  ...
  git clone https://github.com/pratham0039/lxme-chatbot-Agent.git
  cd chatwoot
  git checkout "$BRANCH"
  bundle
  yarn
...
function cwctl_upgrade_check() {
    ...
    local remote_version_url="https://raw.githubusercontent.com/chatwoot/chatwoot/main/VERSION_CWCTL"
